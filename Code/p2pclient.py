...
def p2pserver():
    ...
    def serverprocess(connectionsocket ,address):
        ...
        fullpath='C:\Sivakumar\ASU\SEM 1\CEN 502\Project\Project 2\Send\\'
        Response=[]
...
def p2pinterface():
    ...
    serverName = socket.gethostbyname(socket.gethostname()) # change to server IP address when running on a different machine
    serverPort = 12000
...
# To request for a file
    ...
    while 1:
        ...
        if choice==4:
            ...
            fullpath ='C:\Sivakumar\ASU\SEM 1\CEN 502\Project\Project 2\Received\\'
